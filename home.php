<!-- Blog page for all articles -->
<?php get_header(); ?>

    <?php
        $blog_page_id = get_option('page_for_posts');
        $hero_title = get_field('hero_title', $blog_page_id);
        $hero_content = get_field('hero_content', $blog_page_id);
    ?>
    <section class="category-header">
        <div class="container">
            <div class="d-flex align-items-center mb-4">
                <span class="category-icon"><i class="fas fa-comment-dots"></i></span>
                <?php
                    if($hero_title) {
                        $title = $hero_title;
                    } else {
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <?php if ($post_count === 0) : ?>
                    ...
                    <section class="section-padding pt-0">
                        <div class="row g-4" id="article-posts">
