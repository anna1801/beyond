<?php
add_action('wp_ajax_load_more_article_posts', 'load_more_article_posts');
add_action('wp_ajax_nopriv_load_more_article_posts', 'load_more_article_posts');

function load_more_article_posts() {
...
function theme_enqueue_load_article_scripts() {

    wp_enqueue_script(
        'load-more-articles',
        get_template_directory_uri() . '/ajax/js/article-ajax.js',
        array('jquery'),
        null,
        true
    ); 
...
add_action('wp_enqueue_scripts', 'theme_enqueue_load_article_scripts');